...
(function (global) {
  ...
  const SHARED = {
    fr: {
      ...
      alchSubline: 'Un spin-off stratégique de « The Game ». Gratuit à essayer!',
      alchCTA: 'Jouer maintenant →',
    ...
    en: {
      ...
      alchSubline: 'A strategic spin-off of "The Game". Free to try!',
      alchCTA: 'Play now →',
    ...
    es: {
      ...
      alchSubline: 'Un spin-off estratégico de «The Game». ¡Gratis para probar!',
      alchCTA: 'Jugar ahora →',
  ...
  function alchimixAd(lang) {
    ...
    return [
      ...
      '    <img src="images/alchimix.svg" alt="Alchimix" class="ad-alch-banner" loading="lazy" />',
